...
- [ ] Post Comment.
- [ ] Dùng database.
- [x] Improve MDX Loading Time (mình không biết có thể gọi là improve không, mình dùng `getStaticParams` trong NextJS để build các post này thành HTML ở build time luôn, gọi là Static Site Generation [^2]).
- [ ] Sitemap.
