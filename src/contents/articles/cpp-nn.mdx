...
> Vậy là xong class Ma trận và các hàm phụ trợ rồi ấy, cảm ơn các bạn đã đọc đến đây hehe 🍉. Ở phần sau [Neural Network đơn giản với C++ (Phần 2)](/blog/cpp-nn-2) ta sẽ đi qua kỹ thuật Backpropagation (hay còn gọi là Backward) và cách train Deep Neural Network.
